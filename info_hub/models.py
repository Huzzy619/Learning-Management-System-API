...
from hitcount.models import HitCount, HitCountMixin #This will add a reverse lookup from HitCount Model
...
class Post(models.Model, HitCountMixin):
    ...
    attachment = models.FileField(upload_to = "post_attachment",
        validators=[
